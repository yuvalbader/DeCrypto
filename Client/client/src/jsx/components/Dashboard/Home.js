...
// 				<p className="mb-1 text-white fs-14">Hi There!</p>
// 				<div className="d-flex justify-content-between">
// 					<h2 className="num-text text-white mb-5 font-w600">Take The Questionnaire</h2>
// 				</div>
// 				<div className="d-flex">
// 					<div className="mr-4 text-white">
// 						<p className="fs-12 mb-1 op6">Start Here,</p>
// 					</div>
// 					<div className="text-white">
// 						<p className="fs-12 mb-1 op6">Create a portfolio</p>
